...
cs650names <- colnames(fread(paste(basedir,"dataL1_Soil_2024_demo.csv",sep=""), sep=",", skip=1,heade=TRUE))
cs650wide <- fread(paste(basedir,"dataL1_Soil_2024_demo.csv",sep=""), sep=",", skip=4, col.names = cs650names, na.strings="-9999")
